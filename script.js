...
if (isProductPage) {
  ...
  const products = {
    novabook: {
      ...
      desc: 'A sleek high-performance laptop for students, creators, and professionals.',
      specs: [
        { icon:'⚙️', title:'Intel Core i7', sub:'Smooth multitasking' },
        { icon:'🧠', title:'16GB RAM / 512GB SSD', sub:'Fast launch speed' },
        { icon:'🔋', title:'14-hour battery', sub:'Optimized for all-day use' },
        { icon:'🛡️', title:'Secure checkout', sub:'Protected order flow' }
      ]
    },
    ...
    aerophone: {
      ...
      cat: 'Phones',
      badge: 'New arrival',
      badgeCls: 'new-arrival',
      desc: 'A next-gen flagship smartphone with AI camera and all-day battery.',
      specs: [
        { icon:'📷', title:'200MP AI Camera', sub:'Stunning photos day and night' },
        { icon:'⚡', title:'Snapdragon 8 Gen 3', sub:'Ultra-fast performance' },
        { icon:'🔋', title:'5000mAh Battery', sub:'45W fast charging' },
        { icon:'🛡️', title:'2-Year Warranty', sub:'Full regional coverage' }
      ]
    },
    ...
    echopods: {
      ...
      badge: 'Popular',
      badgeCls: 'popular',
      desc: 'Premium wireless earbuds with noise cancellation and custom sound profile.',
      specs: [
        { icon:'🔇', title:'Active Noise Cancellation', sub:'Block out the world' },
        { icon:'🎵', title:'Custom Audio Driver', sub:'Deep bass, crisp highs' },
        { icon:'🔋', title:'36h Total Battery', sub:'With charging case' },
        { icon:'📶', title:'Bluetooth 5.3', sub:'Low-latency connection' }
      ]
    },
    ...
    pulsewatch: {
      ...
      badge: 'Top rated',
      badgeCls: 'top-rated',
      desc: 'A premium smartwatch that tracks health and productivity in one sleek wearable.',
      specs: [
        { icon:'❤️', title:'Health Tracking', sub:'Heart rate, SpO2, sleep' },
        { icon:'🏃', title:'GPS + Sports Modes', sub:'100+ workout types' },
        { icon:'🔋', title:'7-Day Battery', sub:'Always-on display' },
        { icon:'💧', title:'5ATM Water Resistant', sub:'Swim-proof build' }
      ]
    },
    ...
    visionpad: {
      ...
      cat: 'Laptops',
      badge: 'Student pick',
      badgeCls: 'student-pick',
      desc: 'A lightweight powerhouse tablet with M2 chip and stunning 12.9\" display.',
      specs: [
        { icon:'🖥️', title:'12.9\" Liquid Retina', sub:'ProMotion 120Hz display' },
        { icon:'⚙️', title:'M2 Chip', sub:'Desktop-class performance' },
        { icon:'🔋', title:'10-Hour Battery', sub:'Work all day' },
        { icon:'✏️', title:'Pencil Support', sub:'Perfect for notes and art' }
      ]
    },
    ...
    snapcam: {
      ...
      cat: 'Audio',
      badge: 'Creator gear',
      badgeCls: 'creator-gear',
      desc: 'A professional mirrorless camera with 8K video and AI autofocus.',
      specs: [
        { icon:'🎥', title:'8K Video Recording', sub:'30fps cinematic quality' },
        { icon:'🤖', title:'AI Subject Tracking', sub:'Never miss a moment' },
        { icon:'🔋', title:'600-Shot Battery', sub:'Shoot all day' },
        { icon:'💾', title:'Dual SD Card Slots', sub:'Backup while you shoot' }
      ]
    },
    ...
    gamecore: {
      ...
      badge: 'Hot deal',
      badgeCls: 'hot-deal',
      desc: 'A compact gaming console with 4K support and regional game store.',
      specs: [
        { icon:'🎮', title:'4K @ 120fps Gaming', sub:'Ultra-smooth gameplay' },
        { icon:'💾', title:'1TB NVMe SSD', sub:'Zero load times' },
        { icon:'📶', title:'Wi-Fi 6E + Bluetooth', sub:'Lag-free online gaming' },
        { icon:'🌐', title:'Regional Game Store', sub:'Arabic content included' }
      ]
    },
    ...
    fitband: {
      ...
      cat: 'Wearables',
      badge: 'Budget smart',
      badgeCls: 'budget-smart',
      desc: 'An affordable smart fitness band with health tracking and AMOLED display.',
      specs: [
        { icon:'❤️', title:'Heart Rate Monitor', sub:'24/7 continuous tracking' },
        { icon:'😴', title:'Sleep Analysis', sub:'Smart sleep stage tracking' },
        { icon:'🔋', title:'14-Day Battery', sub:'Worry-free wearable' },
        { icon:'💧', title:'Water Resistant', sub:'Splash and sweat proof' }
      ]
    }
  };
